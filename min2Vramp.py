# -*- coding: utf-8 -*-
"""
Created on Mon Jun  7 14:31:38 2021
...
pt4 = 'D:/Dropbox (KGB Group)/Gravity/LabView/6_7_21_1min2V.txt'
pt4l = 'D:/Dropbox (KGB Group)/Gravity/LabView/6_7_21_1min2VL.txt'
...
jump4 = f04[614]-f04[613]
f04[614:-1] = f04[614:-1]-jump4
print(jump4)
...
BList4 = makeBs(index4, BList4, 8.1, 1, 213, 546)
BList4 = makeBs(index4, BList4, 1, .1, 546, 630)
BList4 = makeBs(index4, BList4, .1, .01, 630, 672)
BList4 = makeBs(index4, BList4, .01, -.01, 672, 719)
BList4 = makeBs(index4, BList4, -.01, -.1, 719, 761)
BList4 = makeBs(index4, BList4, -.1, -1, 761, 846)
BList4 = makeBs(index4, BList4, -1, -8.1, 846, 1179)
...
np.savetxt('BRamp_min2V_6_7_21.txt', wrA, delimiter='\t')
